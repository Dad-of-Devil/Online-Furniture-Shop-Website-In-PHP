            ...
            <div id="costum_slider" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <h1 class="furniture_text">Desining Bed</h1>
                        <p class="there_text">Most modern beds consist of a soft, cushioned mattress on a bed frame. The mattress rests either on a solid base, often wood slats, or a sprung base. Many beds include a box spring inner-sprung base, which is a large mattress-sized box containing wood and springs that provide additional support and suspension for the mattress. </p>
                       
                    </div>
                    <div class="carousel-item">
                        <h1 class="furniture_text">Desining Soffas</h1>
                    ...
                    <div class="carousel-item">
                        <h1 class="furniture_text">Desining Tables</h1>
                        <p class="there_text">Tables are a way of presenting information in rows and columns. They can be useful for a variety of content presentations on Wikipedia, but should be used only when appropriate; sometimes the information in a table may be better presented as prose paragraphs or as an embedded list.</p>
         ...
         <div class="container">
            ...
            <div class="services_section2 layout_padding">
               <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="icon_1"><img src="images/icon-1.png"></div>
                     <h2 class="furnitures_text">Soofass</h2>
                     <p class="dummy_text">There are many variations of passages of Lorem Ipsum available, but the</p>
                     <div class="read_bt_main">
                        <div class="read_bt"><a href="shop.php?sofaas=sofaas">Read More</a></div>
                     </div>
                  </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="lorem_text">There are many variations of passages of Lorem Ipsum available, but the
                        ...
                        don't look even slightly believableThere are many variations of passages of Lorem Ipsum
                        available, but the majority have able</p>
                    <div class="read_bt1"><a href="about.php">Read More</a></div>
                </div>
                <div class="col-md-6">
