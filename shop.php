...
if(isset($_GET["dining"])){
   $dining=$_GET["dining"];
   $show="select * from tbl_add_product where category='$dining'";
...
if(isset($_GET["bed"])){
   $bed=$_GET["bed"];
   $show="select * from tbl_add_product where category='$bed'";
$result=$conn->query($show);
while($row=$result->fetch()){
...
if(isset($_GET["table"])){
   $table=$_GET["table"];
   $show="select * from tbl_add_product where category='$table'";
$result=$conn->query($show);
while($row=$result->fetch()){
...
if(isset($_GET["sofaas"])){
    $sofaas=$_GET["sofaas"];
    $show="select * from tbl_add_product where category='$sofaas'";
 $result=$conn->query($show);
 while($row=$result->fetch()){
